...
| `container`       | string | recommended | runtime default | Container image (`halo-vllm-node`, `halo-llamacpp-node`, or a pinned `repo@sha256:…`). |
